...
//uint8_t broadcastAddress1[] = {0xE4, 0x65, 0xB8, 0xD8, 0xD3, 0x1C}; //Excavator
uint8_t broadcastAddress1[] = {0x3C, 0x8A, 0x1F, 0xD4, 0x0A, 0x38 }; //Truck
...
void processGamepad(ControllerPtr ctl) {
  ...
  remoteData.axisLX = map(ctl->axisRX(), -512, 511, 0, 256);
  remoteData.axisLY = map(ctl->axisRY(), -512, 511, 0, 256);
